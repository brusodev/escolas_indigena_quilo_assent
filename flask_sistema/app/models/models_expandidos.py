...
class Escola(db.Model):
    ...
    diretoria_id = db.Column(db.Integer, db.ForeignKey(
        'diretorias.id'), nullable=False)
    # Nome da diretoria para facilitar consultas
...
class Veiculo(db.Model):
    ...
    # pequeno, medio_grande, medio_grande_4x4
...
class Supervisor(db.Model):
    ...
    # Lista de diretorias separadas por vírgula
    diretorias_supervisionadas = db.Column(db.Text)
