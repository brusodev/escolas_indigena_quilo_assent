...
def converter_para_formato_dashboard(escolas_citem, unidades_regionais):
    ...
    for escola in escolas_citem:
        ...
        diretoria_normalizada = normalizar_diretoria(diretoria_original, unidades_regionais)
...
def main():
    ...
    try:
        ...
        escolas_dashboard, diretorias = converter_para_formato_dashboard(escolas_citem, unidades)
        
        # 4. Gerar arquivos atualizados
        arquivo_dados, arquivo_config = gerar_arquivo_dashboard_atualizado(escolas_dashboard, stats_tipos)
