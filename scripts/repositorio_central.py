...
class RepositorioCentral:
    ...
    def __init__(self):
        # Arquivos principais (fonte única da verdade) - caminhos atualizados
        self.arquivo_principal = (
            "dados/excel/distancias_escolas_diretorias_completo_63_corrigido.xlsx"
        )
        self.arquivo_veiculos = "dados/json/dados_veiculos_diretorias.json"
        self.arquivo_dashboard = "dashboard/dashboard_integrado.html"

        # Arquivos de relatórios (gerados)
        self.relatorio_excel = (
    ...
    def _validar_arquivo_principal(self):
        ...
        try:
            ...
            # Validar diretorias
            diretorias = df["DE_Responsavel"].nunique()
